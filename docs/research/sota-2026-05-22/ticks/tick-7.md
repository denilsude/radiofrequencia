...
- `docs/research/sota-2026-05-22/R14-empathic-appliances.md` — research note covering:
  ...
  - **Infrastructure inventory** — which existing radiofrequencia components map to which empathic-appliance category. 5 ✅ in-repo, 4 ⚠️/❌ to-build.
...
- Which MCP tools to add to `@ruv/radiofrequencia-mcp` (the deferred `radiofrequencia_vitals_subscribe` is now the highest-leverage next addition per ADR-104 + R14).
