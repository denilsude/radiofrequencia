...
- `/workspaces/radiofrequencia/v2/crates/wifi-densepose-signal/src/ruvsense/mod.rs`
- `/workspaces/radiofrequencia/v2/crates/wifi-densepose-signal/src/ruvsense/tomography.rs`
- `/workspaces/radiofrequencia/v2/crates/wifi-densepose-signal/src/ruvsense/multistatic.rs`
- `/workspaces/radiofrequencia/v2/crates/wifi-densepose-signal/src/ruvsense/pose_tracker.rs`
- `/workspaces/radiofrequencia/v2/crates/wifi-densepose-signal/src/ruvsense/field_model.rs`
- `/workspaces/radiofrequencia/v2/crates/wifi-densepose-signal/src/ruvsense/gesture.rs`
- `/workspaces/radiofrequencia/v2/crates/wifi-densepose-signal/src/ruvsense/coherence.rs`
- `/workspaces/radiofrequencia/v2/crates/wifi-densepose-signal/src/ruvsense/coherence_gate.rs`
- `/workspaces/radiofrequencia/v2/crates/wifi-densepose-signal/src/ruvsense/multiband.rs`
- `/workspaces/radiofrequencia/v2/crates/wifi-densepose-signal/src/ruvsense/phase_align.rs`
- `/workspaces/radiofrequencia/v2/crates/wifi-densepose-signal/src/ruvsense/adversarial.rs`
- `/workspaces/radiofrequencia/v2/crates/wifi-densepose-signal/src/ruvsense/intention.rs`
- `/workspaces/radiofrequencia/v2/crates/wifi-densepose-signal/src/ruvsense/longitudinal.rs`
- `/workspaces/radiofrequencia/v2/crates/wifi-densepose-signal/src/ruvsense/cross_room.rs`
- `/workspaces/radiofrequencia/v2/crates/wifi-densepose-signal/src/ruvsense/temporal_gesture.rs`
- `/workspaces/radiofrequencia/v2/crates/wifi-densepose-signal/src/ruvsense/attractor_drift.rs`

### Rust Neural Network
- `/workspaces/radiofrequencia/v2/crates/wifi-densepose-nn/src/inference.rs`
- `/workspaces/radiofrequencia/v2/crates/wifi-densepose-nn/src/tensor.rs`

### Python Pipeline
- `/workspaces/radiofrequencia/v1/src/core/csi_processor.py`
- `/workspaces/radiofrequencia/v1/src/services/pose_service.py`
- `/workspaces/radiofrequencia/v1/src/api/websocket/connection_manager.py`
- `/workspaces/radiofrequencia/v1/src/api/websocket/pose_stream.py`
- `/workspaces/radiofrequencia/v1/src/sensing/feature_extractor.py`

### ESP32 Firmware
- `/workspaces/radiofrequencia/firmware/esp32-csi-node/main/csi_collector.c`
- `/workspaces/radiofrequencia/firmware/esp32-csi-node/main/edge_processing.c`
- `/workspaces/radiofrequencia/firmware/esp32-csi-node/main/edge_processing.h`
